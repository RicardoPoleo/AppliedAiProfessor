...
class OpenAIWrapper:
    ...
    def generate_audio(self, text: str, filename: str, do_not_generate: bool = False,
        ...
        """
        Generate an audio file from the given text using the specified voice model.

        Args:
            text (str): The text to convert to audio.
            filename (str): The name of the audio file to be generated.
            do_not_generate (bool): Flag to disable actual audio generation.
            voice_model (str): The voice model to use for audio generation.
    ...
    def generate_response(self, question, do_not_generate=False):
        ...
        Args:
            ...
            do_not_generate (bool): Flag to disable actual response generation.
    ...
    def setup_rag_assistant(self):
        """
        Set up the Retrieval-Augmented Generation (RAG) assistant and vector store.
        Uploads support files to the vector store.

        Returns:
            tuple: The assistant and vector store instances.
        """
    ...
    def run_rag_query(self, question: str, current_lecture: str, handler=None):
        """
        Run a RAG query to generate an answer for a given question.

        Args:
            question (str): The question to generate an answer for.
            current_lecture (str): The current lecture context.
            handler (AssistantEventHandler, optional): Custom event handler for the query.
...
class EventHandler(AssistantEventHandler):
    ...
    def set_client(self, client):
        """
        Set the OpenAI client for the event handler.
    ...
    def on_text_created(self, text) -> None:
        """
        Handle the event when text is created.

        Args:
            text (str): The created text.
        """
    ...
    def on_tool_call_created(self, tool_call):
        ...
        Args:
            tool_call (ToolCall): The created tool call.
        """
    ...
    def on_message_done(self, message) -> None:
        """
        Handle the event when a message is done.
    ...
    def get_final_response(self):
        """
        Get the final response generated by the event handler.
